...
class User(db.Model):
    ...
    followers: Mapped[list["Follower"]] = relationship(
        back_populates="followed", foreign_keys=["Follower.user_to_id"])
    following: Mapped[list["Follower"]] = relationship(
        back_populates="follower", foreign_keys=["Follower.user_from_id"])
    author: Mapped[list["Comment"]] = relationship(
        back_populates="author", foreign_keys=["Comment.author_id"])
    user_post: Mapped[list["Post"]] = relationship(
        back_populates="user", foreign_keys=["Post.user_id"])
...
class Post(db.Model):
    ...
    media: Mapped[list["Media"]] = relationship(
        back_populates="post", foreign_keys=["Media.posted_id"])
